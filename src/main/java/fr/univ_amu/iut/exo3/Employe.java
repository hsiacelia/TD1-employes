...
public class Employe {
    ...
    public long getNbAnciennete() { return nbAnciennete; }
    ...
    public void nbMois() {
        LocalDate dateEmbauche = date_embauche;
        long nbMois = ChronoUnit.MONTHS.between(dateEmbauche, LocalDate.now());
        this.nbAnciennete = nbMois;
    }

    public void bonusAnciennete() {
        long nb = nbMois();;
        long res = 10 * nb;
        this.bonus = res;
    }
